...
int main() {
...

    {
        ...
        auto storage = container(ct_eq<0>{}, ct_eq<1>{}, ct_eq<2>{});
        auto sliced = hana::detail::sliced(storage, hana::tuple_c<int, 2>);
        BOOST_HANA_CONSTANT_CHECK(hana::equal(
            hana::unpack(sliced, f),
            f(ct_eq<2>{})
        ));
        ...
        auto storage = container(ct_eq<0>{}, ct_eq<1>{}, ct_eq<2>{});
        auto sliced = hana::detail::sliced(storage, hana::tuple_c<int, 0, 2>);
        BOOST_HANA_CONSTANT_CHECK(hana::equal(
            hana::unpack(sliced, f),
            f(ct_eq<0>{}, ct_eq<2>{})
        ));
        ...
        auto storage = container(ct_eq<0>{}, ct_eq<1>{}, ct_eq<2>{});
        auto sliced = hana::detail::sliced(storage, hana::tuple_c<int, 1, 1>);
        BOOST_HANA_CONSTANT_CHECK(hana::equal(
            hana::unpack(sliced, f),
            f(ct_eq<1>{}, ct_eq<1>{})
        ));
...

    {
        ...
        auto sliced = hana::detail::sliced(storage, hana::tuple_c<int, 3, 1, 0, 2, 2>);
        BOOST_HANA_CONSTANT_CHECK(hana::equal(
            hana::unpack(sliced, f),
